...
export default function NavBar() {
  ...
  const user = useSelector((state) => state.userAuthenticated);
    ...
    <Grid container>
      <Grid item size={12}>
        ...
        <Grid item xs={12}>
          <AppBar
            position="static"
            sx={{ backgroundColor: "#6655D9", boxShadow: "none" }}
          >
            <Toolbar sx={{ justifyContent: "space-between" }}>
              ...
              <Box>
                ...
                <Button
                  sx={{ cursor: "pointer" }}
                  color="inherit"
                  onClick={(event) => handleClick(event, "fotoPerfil")}
                >
                  <Avatar
                    src="/src/asd.png"
        ...
        <Grid container sx={{ height: "100vh" }}>
          ...
          <Grid
            ...
            sx={{
              ...
              color: "white",
              boxShadow: "2px 0px 0px 0px rgba(0, 0, 0, 0.3)",
            }}
          >
            <Grid
              container
